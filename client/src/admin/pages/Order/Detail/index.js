            ...
            <Content>
                ...
                <div className="d-flex order-info order-section">
                    <div>
                        ...
                        <div>
                            <span>Họ tên: </span> {orderDetail.HoTen ? orderDetail.HoTen : ""}
                        </div>
                        <div>
                            <span>Email: </span>{" "}
                            {orderDetail.Email
                                ? orderDetail.Email
                                : orderDetail.ThongTinDatHang && orderDetail.ThongTinDatHang.Email}
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <div>
                            <span>Mã đơn hàng: </span> {orderDetail.MaDonHang}
                        </div>
                        <div>
                        ...
                        <div>
                            <span>Trạng thái: </span> {StatusOrder[orderDetail.TrangThai]}
                        </div>
                        <div>
                        ...
                        orderDetail.List.map((item, index) => {
                            return (
                                <Row key={index} className="order-item-value">
                                    ...
                                    <Col>{0}</Col>
                                    <Col>
                                        {item.ThanhTien && item.ThanhTien.toLocaleString("en-US")}{" "}
                                        VND
                                    </Col>
                                </Row>
                            )
                ...
                <div className="order-section order-bill-list">
                        ...
                        <div className="order-bill">
                            ...
                            <span>
                                ...
                                {orderDetail.TongGiaTriChietKhau
                                    ? orderDetail.TongGiaTriChietKhau.toLocaleString("en-US")
                                    : 0}{" "}
                                VND
                            </span>
                        </div>
                    ...
                    <InputGroup className="mb-3">
                        <DropdownButton
                            ...
                            align="end"
                        >
                            <Dropdown.Item href="#" onClick={(e) => onControlClick(e, 0)}>
                                {StatusOrder[0]}
                            </Dropdown.Item>
                            <Dropdown.Divider />

                            <Dropdown.Item href="#" onClick={(e) => onControlClick(e, 1)}>
                                {StatusOrder[1]}
                            </Dropdown.Item>
                            <Dropdown.Divider />
                            <Dropdown.Item href="#" onClick={(e) => onControlClick(e, 2)}>
                                {StatusOrder[2]}
                            </Dropdown.Item>
                            <Dropdown.Divider />
                            <Dropdown.Item href="#" onClick={(e) => onControlClick(e, 3)}>
                                {StatusOrder[3]}
                            </Dropdown.Item>
                            <Dropdown.Divider />
                            <Dropdown.Item href="#" onClick={(e) => onControlClick(e, 4)}>
                                {StatusOrder[4]}
                            </Dropdown.Item>
                            <Dropdown.Divider />
                            <Dropdown.Item href="#" onClick={(e) => onControlClick(e, 5)}>
                                {StatusOrder[5]}
                            </Dropdown.Item>
                            <Dropdown.Divider />
                            <Dropdown.Item href="#" onClick={(e) => onControlClick(e, 6)}>
                                {StatusOrder[6]}
                            </Dropdown.Item>
                        </DropdownButton>
                    </InputGroup>
                ...
                >
                    ...
                    <Modal.Body>
                        Sau khi thay đổi trạng thái bạn sẽ không thể quay lại trạng thái trước. Bạn
