...
const DanhSachDoiTra = () => {
    ...
    const handleChangeStatus = async () => {
        const updateResponse = await orderExchangeAPI.changeStatus({
            id: message.id,
    ...
    return (
        <Container>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Form.Control
                                        ...
                                        className="fs-6"
                                        name="IDDonHang"
                                        value={filter.IDDonHang ? filter.IDDonHang : ""}
                                        onChange={changeFilterHandler}
                                    />
                                </Col>
                            </Row>
                            ...
                            order.map((item, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        <td
                                            className={`text-${
                                                colorTextStatus[item.DonHang_TrangThai]
                                            }`}
                                        >
                                            {StatusOrder[item.DonHang_TrangThai]}
                                        </td>
                                        <td>{toTimeString(item.ThoiGianTao * 1000)}</td>
                                        <td>
                                            {item.DonHang_TongGiaTriDonHang.toLocaleString("en-US")}{" "}
                                            VND
                                        </td>
                                        <td style={{ color: "red" }}>
                                            {item.DonHang_PhuPhi ? item.DonHang_PhuPhi : "Không"}
                                        </td>
            ...
            >
                ...
                <Modal.Body>Xác nhận thay đổi trang thái đơn hàng ?</Modal.Body>
                <Modal.Footer>
