            ...
            <Content>
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            {category && (
                                <Tree
                                    parent={category}
                                    handleShowInfo={showInfoHandler}
                                    handleAddMore={addMoreHandler}
                ...
                {currentCate ? (
                    <div className="category-item-detail">
                        ...
                        >
                            <h2 style={{ textAlign: "center", margin: "10px 0 20px 0" }}>
                                ...
                                {currentCate.IDTheLoaiCha && (
                                    <Form.Group as={Col} md="10" controlId="validationCustom01">
                                        ...
                                        <Form.Control
                                            type="text"
                                            name="IDTheLoaiCha"
                                            value={currentCate.IDTheLoaiCha}
                                        />
                                    </Form.Group>
                                )}
                                <Form.Group as={Col} md="10" controlId="validationCustom01">
