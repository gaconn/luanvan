                            ...
                            <Row>
                                ...
                                <Col>
                                    <Form.Control
                                        ...
                                        className="fs-6"
                                        name="id"
                                        value={orderFilter.id ? orderFilter.id : ""}
                                ...
                                <Col className="col-3">
                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                        ...
                                        <Form.Control
                                            ...
                                            name="startDate"
                                            value={
                                                orderFilter.startDate ? orderFilter.startDate : ""
                                            }
                                            onChange={changeFilterHandler}
                                        />
                                    </Form.Group>
                                ...
                                <Col className="col-3">
                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                        ...
                                        <Form.Control
                                            ...
                                            className="fs-6"
                                            name="endDate"
                                            value={orderFilter.endDate ? orderFilter.endDate : ""}
                                            onChange={changeFilterHandler}
                                        />
                                    </Form.Group>
                                </Col>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Form.Select
                                        ...
                                        defaultValue=""
                                        name="TrangThai"
                                        value={orderFilter.TrangThai ? orderFilter.TrangThai : ""}
                                        onChange={changeFilterHandler}
                                    >
                            ...
                            order.map((item, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        <td style={{ color: "red" }}>
                                            {item.MaChietKhau ? item.MaChietKhau : "Không"}
                                        </td>
