...
class OrderModel {
    ...
    get = async (objCondition) => {
        ...
        try {
            ...
            const dataFormat = {
                HoTen:
                    dataOrder[0] && dataOrder[0].TaiKhoan_HoTen
                        ? dataOrder[0].TaiKhoan_HoTen
                        : null,
                Email:
                    dataOrder[0] && dataOrder[0].TaiKhoan_Email
                        ? dataOrder[0].TaiKhoan_Email
                        : null,
                SoDienThoai:
                    dataOrder[0] && dataOrder[0].TaiKhoan_SoDienThoai
                        ? dataOrder[0].TaiKhoan_SoDienThoai
                        : null,
                TinhThanh:
                    dataOrder[0] && dataOrder[0].TaiKhoan_TinhThanh
                        ? dataOrder[0].TaiKhoan_TinhThanh
                        : null,
                PhuongXa:
                    dataOrder[0] && dataOrder[0].TaiKhoan_PhuongXa
                        ? dataOrder[0].TaiKhoan_PhuongXa
                        : null,
                QuanHuyen:
                    dataOrder[0] && dataOrder[0].TaiKhoan_QuanHuyen
                        ? dataOrder[0].TaiKhoan_QuanHuyen
                        : null,
                SoNha:
                    dataOrder[0] && dataOrder[0].TaiKhoan_SoNha
                        ? dataOrder[0].TaiKhoan_SoNha
                        : null,
                IDDonhang: dataOrder[0] && dataOrder[0].IDDonHang ? dataOrder[0].IDDonHang : 0,
                GiaVanChuyen:
                    dataOrder[0] && dataOrder[0].DonHang_GiaVanChuyen
                        ? dataOrder[0].DonHang_GiaVanChuyen
                        : 0,
                IDPhuongThucThanhToan:
                    dataOrder[0] && dataOrder[0].DonHang_IDPhuongThucThanhToan
                        ? dataOrder[0].DonHang_IDPhuongThucThanhToan
                        : 0,
                IDTaiKhoan:
                    dataOrder[0] && dataOrder[0].DonHang_IDTaiKhoan
                        ? dataOrder[0].DonHang_IDTaiKhoan
                        : null,
                MaChietKhau:
                    dataOrder[0] && dataOrder[0].DonHang_MaChietKhau
                        ? dataOrder[0].DonHang_MaChietKhau
                        : null,
                MaDonHang:
                    dataOrder[0] && dataOrder[0].DonHang_MaDonHang
                        ? dataOrder[0].DonHang_MaDonHang
                        : null,
                PhuPhi:
                    dataOrder[0] && dataOrder[0].DonHang_PhuPhi ? dataOrder[0].DonHang_PhuPhi : 0,
                ThoiGianTao:
                    dataOrder[0] && dataOrder[0].DonHang_ThoiGianTao
                        ? dataOrder[0].DonHang_ThoiGianTao
                        : null,
                ThongTinDatHang:
                    dataOrder[0] && dataOrder[0].DonHang_ThongTinDatHang
                        ? dataOrder[0].DonHang_ThongTinDatHang
                        : null,
                TongGiaTriChietKhau:
                    dataOrder[0] && dataOrder[0].DonHang_TongGiaTriChietKhau
                        ? dataOrder[0].DonHang_TongGiaTriChietKhau
                        : null,
                TongGiaTriDonHang:
                    dataOrder[0] && dataOrder[0].DonHang_TongGiaTriDonHang
                        ? dataOrder[0].DonHang_TongGiaTriDonHang
                        : null,
                TrangThai:
                    dataOrder[0] && dataOrder[0].DonHang_TrangThai
                        ? dataOrder[0].DonHang_TrangThai
                        : 0,
                List: [],
            }
