...
class DiscountModel {
    ...
    insert = async (objData) => {
        ...
        if (
            !objData.ThoiGianBatDau ||
            !objData.ThoiGianKetThuc ||
            objData.ThoiGianBatDau >= objData.ThoiGianKetThuc
        ) {
        ...
        try {
            ...
            if (objData.IDSanPham) {
                ...
                if (existDiscount.data.length > 0) {
                    return ResponseUtil.response(
                        false,
                        "Sản phẩm này đã có chương trình giảm giá. Không thể tạo mới."
                    )
                }
            }
            ...
            var objField = {
                ...
                GiaChietKhauToiDa: objData.GiaChietKhauToiDa
                    ? objData.GiaChietKhauToiDa
                    : undefined,
                DieuKienGiaToiThieu: objData.DieuKienGiaToiThieu
                    ? objData.DieuKienGiaToiThieu
                    : undefined,
                DieuKienGiaToiDa: objData.DieuKienGiaToiDa ? objData.DieuKienGiaToiDa : undefined,
                SoLuongSuDungToiDa: objData.SoLuongSuDungToiDa
                    ? objData.SoLuongSuDungToiDa
                    : undefined,
                ...
                PhanTramChietKhau: objData.PhanTramChietKhau
                    ? objData.PhanTramChietKhau
                    : undefined,
                MaChietKhau,
