        ...
        <div style="padding: 10px;">
            <div className="order-info order-section" style="display: flex; justify-content: space-around;">
                ...
                <div>
                    ...
                    <div><span>Ngày đặt hàng: </span> ${new Date(objOrderDetail.ThoiGianTao*1000).toLocaleDateString()}</div>
                    <div><span>Trạng thái: </span>${Status[objOrderDetail.TrangThai]} </div>
                    <div><span>Hình thức thanh toán: </span> ${objOrderDetail.IDPhuongThucThanhToan === 1 ? "Thanh toán khi nhận hàng": "Thanh toán qua momo"} </div>
                </div>
            </div>
            ...
            box-shadow: none;">
                <div>
                    ...
                    font-weight: bold;">
                        ...
                        <span>${objOrderDetail && objOrderDetail.List && objOrderDetail.List.length ? objOrderDetail.List.length: 0}</span>
                    </div>
                    <div className="order-bill" style="display: flex;
                    justify-content: space-between;
                    border-bottom: 1px solid #aaa;
                    font-weight: bold;">
                        ...
                        <span>+ ${objOrderDetail.TongPhiVanChuyen ? objOrderDetail.TongPhiVanChuyen.toLocaleString('en-US') : 0} VND</span>
                    </div>
                    <div className="order-bill" style="display: flex;
                    justify-content: space-between;
                    border-bottom: 1px solid #aaa;
                    font-weight: bold;">
                        <span>Phụ phí</span>
                        <span>+ ${objOrderDetail.PhuPhi ? objOrderDetail.PhuPhi.toLocaleString('en-US') : 0} VND</span>
                    </div>
                    <div className="order-bill" style="display: flex;
                    justify-content: space-between;
                    border-bottom: 1px solid #aaa;
                    font-weight: bold;">
                        ...
                        <span>- ${objOrderDetail.TongGiaTriChietKhau ? objOrderDetail.TongGiaTriChietKhau.toLocaleString('en-US') : 0} VND</span>
                    </div>
                    
                    <div className="order-bill order-total">
                        <span>Tổng thành tiền</span>
                        <span>${objOrderDetail.TongThanhTien ? objOrderDetail.TongThanhTien.toLocaleString('en-US') : 0} VND</span>
                    </div>
                </div>
            </div>
        </div>
